...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/afarisulhaq/ataea/main/izin | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/afarisulhaq/ataea/main/izin | grep $ipsaya | awk '{print $3}')
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/afarisulhaq/ataea/main/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/afarisulhaq/ataea/main/izin | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/afarisulhaq/ataea/main/izin | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
wget raw.githubusercontent.com/afarisulhaq/ataea/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
